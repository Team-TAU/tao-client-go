...
func TestClient_DeleteUserFollowsReturnsError(t *testing.T) {
	...
	require.ErrorIs(t, err, BadRequestError{"invalid request, fromID can't be blank"})
	require.False(t, deleted)
	...
	deleted, err = client.DeleteUserFollows("123", "")
	require.ErrorIs(t, err, BadRequestError{"invalid request, toID can't be blank"})
	require.False(t, deleted)
...
func TestClient_UnblockUserReturnsError(t *testing.T) {
	...
	require.ErrorIs(t, err, BadRequestError{"invalid request, userID can't be blank"})
	require.False(t, deleted)
...
func TestClient_DeleteVideosReturnsError(t *testing.T) {
	...
	require.ErrorIs(t, err, BadRequestError{"invalid request, IDs can't be empty"})
	require.False(t, deleted)
